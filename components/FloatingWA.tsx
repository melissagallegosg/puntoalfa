...
export default function FloatingWA() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-neon text-bg pl-4 pr-5 py-3 rounded-full shadow-[0_4px_24px_rgba(198,241,53,0.3)] hover:shadow-[0_4px_32px_rgba(198,241,53,0.5)] transition-shadow"
    ...
    >
      ...
      <span className="text-[12px] font-bold tracking-[0.5px] hidden sm:block">WhatsApp</span>
    </motion.a>
  );
}
